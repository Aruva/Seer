...
from spellbot.models import WargameArmy, WargameProfile
...
class WargameArmiesService:
    ...
    def delete(
        ...
        from spellbot.models import WargameMatchPlayer
    ...
    def get_army_stats(
        ...
        from spellbot.models import WargameMatch, WargameMatchPlayer
