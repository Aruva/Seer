...
class MatchCog(commands.Cog):
    ...
    async def _handle_pending(self, interaction: discord.Interaction) -> None:
        ...
        from spellbot.services import LeagueMatchesService, LeagueSeasonsService
    ...
    async def _handle_list(
        ...
        assert interaction.guild is not None
        from spellbot.services import LeagueDecksService, LeagueMatchesService, LeagueSeasonsService
