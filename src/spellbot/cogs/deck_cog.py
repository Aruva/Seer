...
from spellbot.models import VALID_DECK_LIST_HOSTS
...
class DeckCog(commands.Cog):
    ...
    async def _handle_create(
        ...
        from spellbot.services import LeagueConfigService, LeagueDecksService
    ...
    async def _handle_list(self, interaction: discord.Interaction) -> None:
        assert interaction.guild is not None
        from spellbot.services import LeagueDecksService
    ...
    async def _handle_stats(
        ...
        assert interaction.guild is not None
        from spellbot.services import LeagueDecksService, LeagueSeasonsService
