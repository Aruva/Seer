...
from spellbot.models import LeagueDeck, LeagueProfile, LeagueSeason
from spellbot.services import LeagueConfigService, LeagueDecksService, LeagueMatchesService, LeagueSeasonsService
from spellbot.services.league_elo import SEAT_BASELINE_WIN_RATES, SEAT_LABELS
...
async def log_match(
    ...
    # ── Build the embed ───────────────────────────────────────────────────────
    from spellbot.views import LeagueMatchView
