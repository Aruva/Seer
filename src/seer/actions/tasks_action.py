...
from seer.database import db_session_manager, rollback_session
from seer.metrics import add_span_error, setup_ignored_errors
...
from seer.services import GamesService, ServicesRegistry
...
if TYPE_CHECKING:
    ...
    from seer.models import GameDict
...
class TasksAction:
    ...
    @classmethod
    @asynccontextmanager
    async def create(cls, bot: Seer) -> AsyncGenerator[TasksAction, None]:
        action = cls(bot)
