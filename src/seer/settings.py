...
class Settings:
    ...
    def __init__(self, guild_xid: int | None = None) -> None:  # noqa: PLR0915
        ...
        # content
        self.CONTENT_ROOT = "https://raw.githubusercontent.com/Southsidestudio"
        self.SUBSCRIBE_LINK = "https://southsidestudioandhobbies.com"
        self.DONATE_LINK = "https://southsidestudioandhobbies.com"
        ...
        self.BOT_INVITE_LINK = (
            f"https://discordapp.com/api/oauth2/authorize"
            f"?client_id={self.BOT_APPLICATION_ID or ''}"
            f"&permissions=2416045137"
        ...
        self.ADMIN_ROLE = "SouthSeer Admin"
    ...
    def ICO_URL(self) -> str:
        return self.workaround_over_eager_caching(
            "https://southsidestudioandhobbies.com/images/seer-icon.png",
        )
