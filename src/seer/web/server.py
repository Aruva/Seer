...
from seer.logs import configure_logging

configure_logging(getenv("LOG_LEVEL") or "INFO")

from seer.database import initialize_connection  # noqa: E402
from seer.environment import running_in_pytest  # noqa: E402
