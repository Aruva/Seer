...
from seer.actions import AdminAction
from seer.enums import GAME_BRACKET_ORDER, GAME_FORMAT_ORDER, GAME_SERVICE_ORDER
from seer.metrics import add_span_context
from seer.settings import settings
from seer.utils import for_all_callbacks, is_admin, is_guild
...
class AdminCog(commands.Cog):
    ...
    @app_commands.command(name="setup", description="Setup SouthSeer on your server.")
    ...
    @app_commands.describe(game_id="SouthSeer ID of the game")
