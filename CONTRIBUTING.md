...
SouthSeer requires a database to run properly. The connection string for the database you want to use must be stored in the environment variable `DATABASE_URL`.
...
From this shell you will be able to interact with the database using SouthSeer models and code. For example:
