...
Documentation on how to manage the database instance for SouthSeer.
...
```sql
create role southseer_readonly_user with login password 'OMIT';
GRANT CONNECT ON DATABASE southseer TO southseer_readonly_user;
GRANT USAGE ON SCHEMA public TO southseer_readonly_user;
GRANT SELECT ON ALL TABLES IN SCHEMA public TO southseer_readonly_user;
```
